...
## Project Structure
- `data/` - Contains the raw and cleaned retail sales datasets.
- `sql_scripts/` - All SQL queries used for analysis and business questions.
- `reports/` - Optional folder for any exported results, charts, or summaries.
